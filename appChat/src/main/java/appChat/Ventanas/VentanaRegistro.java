		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (nombreField.getText().isBlank()) {
					JOptionPane.showMessageDialog(frame, "El campo de Nombre tiene que estar relleno", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (apellidosField.getText().isBlank()) {
					JOptionPane.showMessageDialog(frame, "El campo de Apellido tiene que estar relleno", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (telefono.getText().isBlank()) {
					JOptionPane.showMessageDialog(frame, "El campo de Telefono tiene que estar relleno", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (contraseña.getText().isBlank()) {
					JOptionPane.showMessageDialog(frame, "El campo de Contraseña tiene que estar relleno", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (repetirContra.getText().isBlank()) {
					JOptionPane.showMessageDialog(frame, "El campo de Repetir Contraseña tiene que estar relleno",
							"Error", JOptionPane.ERROR_MESSAGE);
				} else if (areaEstado.getText().isBlank()) {
					JOptionPane.showMessageDialog(frame, "El campo de Estado tiene que estar relleno", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (!repetirContra.getText().equals(contraseña.getText())) {
					JOptionPane.showMessageDialog(frame, "Las contraseñas no coinciden.", "No Contraseñas",
							JOptionPane.ERROR_MESSAGE);
				} else {
					...
					if (dateChooser.getDate() != null) {
						fecha = dateChooser.getDate().toInstant().atZone(java.time.ZoneId.systemDefault())
								.toLocalDate();
					}
