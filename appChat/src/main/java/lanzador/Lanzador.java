 ...
 * incluyendo la configuración y arranque de un servidor de persistencia de datos 
 * y la carga de la aplicación principal.
 * 
 * También registra algunos usuarios de ejemplo y lanza la ventana de login para la interacción con el usuario.
 */
