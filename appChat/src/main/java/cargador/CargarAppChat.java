...
public class CargarAppChat {
	...
	public static void main(String[] args) {
		...
		appChat.registrarUsuario("11", "aa", "/usuarios/fotoJGM.png", "aa", LocalDate.of(1960, 10, 3), "Hola, soy jesus");
		appChat.registrarUsuario("22", "bb", "/usuarios/foto-elena.png", "bb", LocalDate.of(1995, 12, 28), "hola, soy elena");
		appChat.registrarUsuario("33", "cc", "/usuarios/rosalia.jpg", "cc", LocalDate.of(2000, 5, 15), "hola, soy rosalia");
		appChat.registrarUsuario("44", "dd", "/usuarios/foto-diego.png", "dd", LocalDate.of(1970, 5, 11), "hola, soy diego");
		...
		ContactoIndividual c1 = RepositorioUsuario.getUnicaInstancia().buscarUsuarioPorMovil("22").getContactoIndividual("11");
